...
public class JniTest {
    ...
    public static native int NumberFromC(String txt_path, String image_path, String outimage_path);//嵌入秘密信息到图片 renumber.c
    //public static native void extractMsg();//从图片中提取出秘密信息 extraction.c
    public static native String extractMsg(String txt_path, String outimage_path);//从图片中提取出秘密信息 extraction.c
    static {
